...
UnwrapPLSQL has six clear parts:
...
4. Open `http://localhost:8080/unwrapplsql/`, `http://localhost:8080/jsonformatter/`, `http://localhost:8080/textcompare/`, `http://localhost:8080/xml-formatter/`, or `http://localhost:8080/base64-tool/` for a specific tool.
5. For a standalone static preview of the XML or Base64 tools, you can also open `xml-formatter/index.html` or `base64-tool/index.html` directly in a browser.
...
3. Render will build the Spring Boot app and copy `unwrapplsql/`, `jsonformatter/`, `textcompare/`, `xml-formatter/`, and `base64-tool/` into `Backend/src/main/resources/static` during the Docker build.
